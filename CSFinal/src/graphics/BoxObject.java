...
public class BoxObject extends GameObject 
{
	...
	{
		shape = new Box((float)scale.getX(), (float)scale.getY(), (float)scale.getZ(), Primitive.GENERATE_NORMALS + Primitive.GENERATE_TEXTURE_COORDS, material);
	}
